...
Route::get('/fix-laravel', function () {
    ...
    return 'Laravel cache cleared and rebuilt.';
});
...
// routes/web.php
    ...
    Route::resource('typeofworks', TypeOfWorkController::class);

    Route::get('/contractors', [VendorController::class, 'contractorIndex'])->name('vendors.contractor');

    Route::get('/vendors/{id}/show', [VendorController::class, 'contractorshow'])->name('vendors.contractor_show');

    Route::get('/suppliers', [VendorController::class, 'supplierIndex'])->name('vendors.supplier');

    Route::get('/vendor/supplier/{id}', [VendorController::class, 'suppliershow'])->name('vendor.supplier.show');
...
Route::prefix('reports')->group(function () {
    Route::get('project-wise', [ReportController::class, 'projectWiseReport'])->name('reports.project-wise');
    Route::get('employee-wise', [ReportController::class, 'employeeWiseReport'])->name('reports.employee-wise');
    Route::get('branch-wise', [ReportController::class, 'branchWiseReport'])->name('reports.branch-wise');
    Route::get('department-wise', [ReportController::class, 'departmentWiseReport'])->name('reports.department-wise');
   
    Route::get('reports/generate', [ReportController::class, 'generateReport'])->name('report.generate');

    Route::post('/get-projects', [ReportController::class, 'getProjects'])->name('get.projects');

    Route::get('/project-wise-report', [ReportController::class, 'projectWiseReport'])
    ->name('project.wise.report');
    
    Route::get('/project-wise-export', [ReportController::class, 'projectWiseExport'])
    ->name('project.wise.export');
    
    Route::get('/employee-wise-export', [ReportController::class, 'employeeWiseExport'])
    ->name('employee.wise.export');
    
    Route::get('/branch-wise-export', [ReportController::class, 'branchWiseExport'])
    ->name('branch.wise.export');
    
    Route::get('/department-wise-export', [ReportController::class, 'departmentWiseExport'])
    ->name('department.wise.export');

    Route::post('get-departments-by-branch', [ReportController::class, 'getDepartmentsByBranch'])->name('get.departments.by.branch');
    Route::post('get-employees-by-department', [ReportController::class, 'getEmployeesByDepartment'])->name('get.employees.by.department');
...
Route::middleware(['auth'])->group(function () {
    ...
    // Route::resource('notice', NoticeController::class)->middleware(['auth', 'XSS']);
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('get-employees-by-department/{id}', [ProjectController::class, 'getEmployeesByDepartment']);
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/timesheet/{timeSheet}', [TimeSheetController::class, 'show'])->name('timesheet.show');
     ...
     Route::get('/get-client-projects/{clientId}', [TimeSheetController::class, 'getClientProjects'])
        ->name('get-client-projects')
        ->where('clientId', '[0-9]+'); // Ensure clientId is numeric
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::post('employee/confirm-employment', [EmployeeController::class, 'confirmEmployment'])->name('employee.confirm-employment')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::post('employee/cancel-employment', [EmployeeController::class, 'cancelEmployment'])->name('employee.cancel-employment')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::resource('deduction', DeductionController::class)->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    // TDS Routes
    Route::get('tds', [TDSController::class, 'index'])->name('tds.index')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::get('tds/{id}/edit', [TDSController::class, 'edit'])->name('tds.edit')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::get('tds/{id}/new-regime', [TDSController::class, 'newRegime'])->name('tds.new.regime')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('tds/allowance/store', [TDSController::class, 'storeAllowance'])->name('tds.allowance.store')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::put('tds/allowance/{id}/update', [TDSController::class, 'updateAllowance'])->name('tds.allowance.update')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('tds/allowance/{id}/delete', [TDSController::class, 'deleteAllowance'])->name('tds.allowance.delete')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('tds/deduction/store', [TDSController::class, 'storeDeduction'])->name('tds.deduction.store')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::put('tds/deduction/{id}/update', [TDSController::class, 'updateDeduction'])->name('tds.deduction.update')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('tds/deduction/{id}/delete', [TDSController::class, 'deleteDeduction'])->name('tds.deduction.delete')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('tds/toggle-payment', [TDSController::class, 'togglePayment'])->name('tds.toggle.payment')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('tds/update-monthly-tds', [TDSController::class, 'updateMonthlyTds'])->name('tds.update.monthly.tds')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('tds/save-type', [TDSController::class, 'saveTdsType'])->name('tds.save.type')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::get('tds/old-regime/{id}', [TDSController::class, 'oldRegime'])->name('tds.old.regime')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::get('tds/new-regime/{id}', [TDSController::class, 'newRegime'])->name('tds.new.regime')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('tds/log-click', [TDSController::class, 'logClick'])->name('tds.log.click')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::post('letter_templates/generate-pdf/{id}', [LetterTemplateController::class, 'generatePdf'])->name('letter_templates.generatePdf')->middleware(['auth', 'XSS']);
    Route::get('letter_templates/download-pdf/{filename}', [LetterTemplateController::class, 'downloadPdf'])->name('letter_templates.downloadPdf')->middleware(['auth', 'XSS']);
    Route::post('letter_templates/load-content', [LetterTemplateController::class, 'loadLetterContent'])->name('letter_templates.loadContent')->middleware(['auth', 'XSS']);
    
    // Generated Letters
    Route::get('letter_templates/generated', [LetterTemplateController::class, 'generatedLettersIndex'])->name('letter_templates.generated.index')->middleware(['auth', 'XSS']);
    Route::get('letter_templates/generated/{id}/view', [LetterTemplateController::class, 'viewGeneratedLetter'])->name('letter_templates.generated.view')->middleware(['auth', 'XSS']);
    Route::delete('letter_templates/generated/{id}', [LetterTemplateController::class, 'deleteGeneratedLetter'])->name('letter_templates.generated.delete')->middleware(['auth', 'XSS']);
    Route::resource('letter_templates', LetterTemplateController::class)->middleware(
        [
            'auth',
            'XSS',
        ]
...
Route::middleware(['auth'])->group(function() {
    Route::resource('joballocation', 'App\Http\Controllers\JobAllocationController');
    
    // Custom routes
    Route::get('joballocation/{id}/show', [JobAllocationController::class, 'show'])
        ->name('joballocation.show');
    
    Route::get('/get-projects/{client_id}', [JobAllocationController::class, 'getProjects'])
        ->name('get-projects');
    
    Route::get('/get-employees', [JobAllocationController::class, 'getEmployeesByDepartments'])
        ->name('get-employees');
    
    Route::get('/get-approvers', [JobAllocationController::class, 'getApprovers'])
