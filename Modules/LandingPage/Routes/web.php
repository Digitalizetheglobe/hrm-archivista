...
// });
Route::get('/get-subcategories/{category_id}', [LandingPageController::class, 'getSubcategories'])->name('get.subcategories');
Route::post('/vendor/store', [LandingPageController::class, 'vendorStore'])->name('vendor.store');
Route::post('/vendor2/store', [LandingPageController::class, 'vendor2store'])->name('vendor2.store');


Route::get('/', [LandingPageController::class, 'home'])->name('home');
Route::get('/pricing', [LandingPageController::class, 'pricing'])->name('pricing');
Route::get('/contact', [LandingPageController::class, 'contact'])->name('contact');
Route::get('/supplier', [LandingPageController::class, 'vendor'])->name('supplier');
Route::get('/contractor', [LandingPageController::class, 'vendor2'])->name('contractor');
