    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::select('type', ['monthly' => __('Monthly'), 'yearly' => __('Yearly')], 'yearly', ['class' => 'form-control', 'required'=>'required']) }}
                </div>
                @error('type')
                    <span class="invalid-name" role="alert">
                        <strong class="text-danger">{{ $message }}</strong>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <div class="form-check">
                    {{ Form::checkbox('is_unlimited', 1, false, ['class' => 'form-check-input', 'id' => 'is_unlimited']) }}
        ...
        <div class="col-lg-12 col-md-12 col-sm-12" id="carry_forward_section">
            <div class="form-group">
                ...
                <div class="form-check">
                    {{ Form::checkbox('carry_forward_enabled', 1, false, ['class' => 'form-check-input', 'id' => 'carry_forward_enabled']) }}
                ...
                <div class="form-icon-user">
                    <div class="form-check-group">
                        ...
                        @foreach($employeeTypes as $value => $label)
                            <div class="form-check">
                                {{ Form::checkbox('eligible_employee_types[]', $value, false, ['class' => 'form-check-input', 'id' => 'employee_type_' . $value]) }}
                                {{ Form::label('employee_type_' . $value, $label, ['class' => 'form-check-label']) }}
                            </div>
                        @endforeach
                    </div>
                </div>
