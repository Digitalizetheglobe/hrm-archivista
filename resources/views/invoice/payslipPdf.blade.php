                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <address>
                                        ...
                                        <strong>{{ __('Position') }} :</strong> {{ __('Contractor') }}<br>
                                ...
                                <div class="col-md-6 text-md-right">
                                    <address>
                                        ...
                                        @php
                                            ...
                                            if ($branchName == 'pune') {
                                                echo '201 & 202, Sai Empire,<br>Near Kapil Malhar, Baner<br>Pune Maharashtra 411 045<br>';
                                            } elseif ($branchName == 'chennai') {
                                                echo 'C4-4th Floor, Tower-III<br>#766, Shakthi Tower, Anna Salai<br>Chennai 600 002<br>';
                                            } else {
                                                echo \Utility::getValByName('company_address') . ',<br>' . \Utility::getValByName('company_city') . ',<br>' . \Utility::getValByName('company_state') . '-' . \Utility::getValByName('company_zipcode') . '<br>';
                                            }
                                        @endphp
                                        <strong>{{ __('Invoice Slip') }} :</strong>
