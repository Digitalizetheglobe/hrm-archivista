...
<div class="modal-body">
    <div class="text-md-end mb-2">
        ...
        @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'hr')
            <a title="Mail Send" href="{{ route('invoice.send', [$employee->id, $payslip->salary_month]) }}" 
            ...
            <div class="col-12">
                <div style="width: 100%; border: 2px solid #000; padding: 0; font-family: Arial, sans-serif; font-size: 11px; line-height: 1.1;">
                    ...
                    <div style="border-top: 2px solid #000; border-bottom: 1px solid #000; padding: 4px; text-align: center; background-color: #f8f9fa;">
                        <h3 style="margin: 0; font-size: 18px; font-weight: bold;">Invoice Slip for {{ strtoupper(date('F - Y', strtotime($payslip->salary_month))) }}</h3>
                    </div>
                            ...
                            <td style="width: 33.33%; border-right: 2px solid #000; padding: 0; vertical-align: top;">
                                <table style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <tr style="border-bottom: 1px solid #000;">
                                        ...
                                        <td style="padding: 4px; border-left: 1px solid #000;">{{ $employee->department->name ?? 'N/A' }}</td>
                                    </tr>
                                    <tr style="border-bottom: 1px solid #000;">
                            ...
                            <td style="width: 33.33%;  padding: 0; vertical-align: top;">
                                <table style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <tr style="border-bottom: 1px solid #000;">
                                        ...
                                        <td style="padding: 4px; border-left: 1px solid #000;">{{ $employee->designation->name ?? 'N/A' }}</td>
                                    </tr>
                                    <tr style="border-bottom: 1px solid #000;">
...
<script>
    function saveAsPDF() {
        ...
        var opt = {
            margin: 0.1,
            filename: '{{ $employee->name }}_{{ $payslip->salary_month }}_invoice',
            image: {
                type: 'jpeg',
                quality: 1
            },
