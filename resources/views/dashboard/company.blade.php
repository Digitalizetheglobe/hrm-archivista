                                    ...
                                    <tbody>
                                        @foreach ($presentEmployeesWithClockIn as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    @if(($data['clock_out'] ?? '--:--') !== '--:--' && ($data['clock_out'] ?? '') !== '00:00:00')
                                ...
                                <tbody>
                                    @forelse ($siteAttendanceEmployees as $data)
                                        <tr>
                                            ...
                                            <td>{{ !empty($data['clock_in_2']) && $data['clock_in_2'] !== '00:00:00' ? $data['clock_in_2'] : '--' }}</td>
                                            <td style="font-size:12px;color:var(--text-muted);">
                                                @php $loc2 = $data['clock_in_2_location'] ?? ''; $clockIn2 = $data['clock_in_2'] ?? '00:00:00'; $parts = explode(',', $loc2); echo !empty($loc2) && $loc2 != '--:--' && $clockIn2 !== '00:00:00' ? e(trim($parts[0])) : '--'; @endphp
                                            </td>
                                            <td>{{ !empty($data['clock_out_2']) && $data['clock_out_2'] !== '00:00:00' ? $data['clock_out_2'] : '--' }}</td>
                                            <td style="font-size:12px;color:var(--text-muted);">
                                                @php $outLoc2 = $data['clock_out_2_location'] ?? ''; $clockOut2 = $data['clock_out_2'] ?? '00:00:00'; $parts = explode(',', $outLoc2); echo !empty($outLoc2) && $outLoc2 != '--:--' && $clockOut2 !== '00:00:00' ? e(trim($parts[0])) : '--'; @endphp
                                            </td>
                                            <td>{{ !empty($data['clock_out']) && $data['clock_out'] !== '00:00:00' ? $data['clock_out'] : '--' }}</td>
                                            <td style="font-size:12px;color:var(--text-muted);">
                                                @php $outLoc = $data['clock_out_location'] ?? ''; $clockOut = $data['clock_out'] ?? '00:00:00'; $parts = explode(',', $outLoc); echo !empty($outLoc) && $outLoc != '--:--' && $clockOut !== '00:00:00' ? e(trim($parts[0])) : '--'; @endphp
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
