        ...
        @endif
                ...
                <li
                    ...
                    <ul class="dash-submenu">
                        ...
                        <!-- @can('Manage Biometric Attendance')
                            ...
                            <li class="dash-item">
                                <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" href="{{ route('biometric-attendance.index') }}">{{ __('Biometric Attendance') }}</a>
                            </li>
            ...
            @auth
                <li class="dash-item {{ Request::segment(1) == 'site-visit' ? 'active' : '' }}">
                    <a href="{{ route('site-visit.index') }}" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                        <span class="dash-micon shadow-none" style="background: none;">
                            <i class="ti ti-map-pin text-white text-[30px]"></i>
                        </span>
                        <span class="dash-mtext flex-grow">{{ __('Site Visit') }}</span>
                    </a>
                </li>
            @endauth
            ...
            @if (\Auth::user()->type == 'company')
                <li class="dash-item">
                    <a href="{{ route('clients.index') }}" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                    <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
            ...
            @if (\Auth::user()->type == 'company')
                <li class="dash-item">
                    <a href="{{ route('joballocation.index') }}" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                        <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                            <i class="fas fa-tasks text-white text-[30px]"></i>
                        </span>
                        <span class="dash-mtext">{{ __('Job Allocation') }}</span>
                    </a>
                </li>
            @endif
            ...
            @if (\Auth::user()->type == 'company')
                <li class="dash-item dash-hasmenu">
                    ...
                    <ul class="dash-submenu">
                        <li class="dash-item">
                            <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" 
                            href="{{ route('reports.project-wise') }}">
                            {{ __('Project-Wise Report') }}
                            </a>
                        </li>
                        <li class="dash-item">
                            <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" 
                            href="{{ route('reports.employee-wise') }}">
                            {{ __('Employee-Wise Monthly Report') }}
                            </a>
                        </li>
                        <li class="dash-item">
                            <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" 
                            href="{{ route('reports.branch-wise') }}">
                            {{ __('Branch-Wise Report') }}
                            </a>
                        </li>
                        <li class="dash-item">
                            <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" 
                            href="{{ route('reports.department-wise') }}">
            ...
            <li class="dash-item">
             ...
             <!-- enquiry -->
                ...
                @if($user->employee && $user->employee->department && $user->employee->department->name == 'estimation')
                    <li class="dash-item">
                        <a href="{{ route('categories.index') }}" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                            <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                    ...
                    <li class="dash-item">
                        <a href="{{ route('subcategories.index') }}" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                            <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                                <i class="fas fa-sitemap text-white text-[30px]"></i>
                            </span>
                            <span class="dash-mtext">{{ __('Sub-Categories') }}</span>
                        </a>
                    </li>

                    <li class="dash-item">
                        <a href="{{ route('typeofworks.index') }}" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                            <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                                <i class="fas fa-tasks text-white text-[30px]"></i>
                            </span>
                            <span class="dash-mtext">{{ __('Type of Work') }}</span>
                        </a>
                    </li>
                    ...
                    <li
                        ...
                        <ul class="dash-submenu ">
                                <li class="dash-item {{ Request::routeIs('vendors.supplier') ? 'active' : '' }}">
                                    <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" href="{{ route('vendors.supplier') }}">
                                        {{ __('Supplier Detail') }}
                                    </a>
                                </li>
                                <li class="dash-item {{ Request::routeIs('vendors.contractor') ? 'active' : '' }}">
                                <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" href="{{ route('vendors.contractor') }}">
                                    {{ __('Contractor Detail') }}
                                </a>
                            </li>
            ...
            <!-- Letter Templates -->
            @if (\Auth::user()->type == 'company')
                <li class="dash-item {{ Request::segment(1) == 'letter_templates' ? 'active' : '' }}">
                    <a href="{{ route('letter_templates.index') }}" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                        <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                            <i class="fas fa-envelope-open-text text-white text-[30px]"></i>
                        </span>
                        <span class="dash-mtext">{{ __('Letter Templates') }}</span>
                    </a>
                </li>
            @endif
            <!-- Letter Templates -->
            ...
            <!-- Exit Formalities -->
                <li
                    ...
                    <ul class="dash-submenu ">
                        <li class="dash-item {{ Request::segment(1) == 'setsalary' ? 'active' : '-' }}">
                            <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" href="{{ route('resignation.index') }}">{{ __('Resignation') }}</a>
                        </li>
                        <li class="dash-item">
                            <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" href="{{ route('termination.index') }}">{{ __('Exit Formalities') }}</a>
                        </li>
