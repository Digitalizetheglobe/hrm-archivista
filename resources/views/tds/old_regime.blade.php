...
@section('page-title')
    {{ __('TDS Calculation') }} - {{ $employee->name }}
@endsection
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header">
                    <h5>{{ __('TDS Calculation Details') }}</h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr class="table-warning">
                                    <th>{{ __('Total ') }}</th>
                                    <td>{{ formatIndian((($employee->set_salary * 12) + $allowances->sum('amount')) - (2500 + 50000)) }}</td>
                                </tr>
                                <tr>
                                    <th>{{ __('Deduction ') }}</th>
                                ...
                                <tr class="table-info">
                                    ...
                                    <td>{{ formatIndian((($employee->set_salary * 12) + $allowances->sum('amount')) - (2500 + 50000 + $deductions->sum('amount'))) }}</td>
                                </tr>                               
                                <tr>
                                    <th>{{ __('Tax') }}</th>
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <tbody id="deductionTableBody">
                                ...
                                <tr data-id="{{ $deduction->id }}">
                                    ...
                                    <td>{{ formatIndian(round($deduction->amount)) }}</td>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-warning" onclick="editDeduction({{ $deduction->id }}, '{{ $deduction->deduction_type }}', {{ round($deduction->amount) }})">
                                            <i class="ti ti-edit"></i>
                                        </button>
