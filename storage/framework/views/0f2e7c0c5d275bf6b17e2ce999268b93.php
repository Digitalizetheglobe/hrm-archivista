<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="form-label font-bold"><?php echo e(__('Start Date')); ?></label>
                <p><?php echo e(Auth::user()->dateFormat($siteVisit->start_date)); ?></p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label class="form-label font-bold"><?php echo e(__('End Date')); ?></label>
                <p><?php echo e(Auth::user()->dateFormat($siteVisit->end_date)); ?></p>
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
