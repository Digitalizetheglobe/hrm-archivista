...
<div class="navbar-wrapper">
    <div class="m-header main-logo">
        <a href="<?php echo e(route('dashboard')); ?>" class="b-brand">
            <img src="<?php echo e(asset('storage/uploads/logo/logo.png')); ?>" 
                alt="<?php echo e(config('app.name', 'Archivista')); ?>" 
                class="logo logo-lg" 
                style="height: 70px;">
        </a>
    </div>
        ...
        <?php endif; ?>
                ...
                <li
                    ...
                    <ul class="dash-submenu">
                        ...
                        <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Biometric Attendance')): ?>
                            ...
                            <li class="dash-item">
                                <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" href="<?php echo e(route('biometric-attendance.index')); ?>"><?php echo e(__('Biometric Attendance')); ?></a>
                            </li>
            ...
            <?php if(auth()->guard()->check()): ?>
                <li class="dash-item <?php echo e(Request::segment(1) == 'site-visit' ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('site-visit.index')); ?>" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                        <span class="dash-micon shadow-none" style="background: none;">
                            <i class="ti ti-map-pin text-white text-[30px]"></i>
                        </span>
                        <span class="dash-mtext flex-grow"><?php echo e(__('Site Visit')); ?></span>
                    </a>
                </li>
            <?php endif; ?>

            <!-- Leave -->
            <?php if(Gate::check('Manage Leave')): ?>
                <li
                    class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'calender' && Request::segment(2) == 'leave' ? 'dash-trigger active' : ''); ?>">
                    <a href="#!" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2"><span class="dash-micon text-white text-[30px] shadow-none" style="background: none;"><i
                                class="ti ti-clock text-white text-[30px]"></i></span><span
                    ...
                    <ul class="dash-submenu">
                        ...
                        <?php if(\Auth::user()->type == 'company'): ?>
                            ...
                            <li class="dash-item <?php echo e(Request::segment(1) == 'carry-forward-leaves' ? ' active' : ''); ?>">
                                <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" href="<?php echo e(route('leave.carryforward')); ?>"><?php echo e(__('Carryforward Leaves')); ?></a>
                            </li>

                            <li class="dash-item <?php echo e(Request::segment(1) == 'leave-details' ? ' active' : ''); ?>">
                                <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" href="<?php echo e(route('leave.details')); ?>"><?php echo e(__('Leave Details')); ?></a>
                            </li>
            ...
            <?php if(\Auth::user()->type == 'company'): ?>
                <li class="dash-item">
                    <a href="<?php echo e(route('clients.index')); ?>" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                    <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
            ...
            <?php if(\Auth::user()->type == 'company'): ?>
                <li class="dash-item">
                    ...
                    <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                    <i class="fas fa-project-diagram text-white text-[30px]"></i></span>
            ...
            <?php if(\Auth::user()->type == 'company'): ?>
                <li class="dash-item">
                    <a href="<?php echo e(route('joballocation.index')); ?>" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                        <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                            <i class="fas fa-tasks text-white text-[30px]"></i>
                        </span>
                        <span class="dash-mtext"><?php echo e(__('Job Allocation')); ?></span>
                    </a>
                </li>
            <?php endif; ?>

            <!-- Add this new Reports menu section -->
            <?php if(\Auth::user()->type == 'company'): ?>
                <li class="dash-item dash-hasmenu">
                    <a href="#!" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                        <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                            <i class="fas fa-chart-bar text-white text-[30px]"></i>
                        </span>
                    ...
                    <ul class="dash-submenu">
                        <li class="dash-item">
                            <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" 
                            href="<?php echo e(route('reports.project-wise')); ?>">
                            <?php echo e(__('Project-Wise Report')); ?>

                            </a>
                        </li>
                        <li class="dash-item">
                            <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" 
                            href="<?php echo e(route('reports.employee-wise')); ?>">
                            <?php echo e(__('Employee-Wise Monthly Report')); ?>

                            </a>
                        </li>
                        <li class="dash-item">
                            <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" 
                            href="<?php echo e(route('reports.branch-wise')); ?>">
                        ...
                        <li class="dash-item">
                            <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" 
                            href="<?php echo e(route('reports.department-wise')); ?>">
            ...
            <li class="dash-item">
                ...
                <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                <i class="fas fa-bullhorn text-white text-[30px]"></i></span>
             ...
             <!-- enquiry -->
                ...
                <?php if($user->employee && $user->employee->department && $user->employee->department->name == 'estimation'): ?>
                    <li class="dash-item">
                        <a href="<?php echo e(route('categories.index')); ?>" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                            <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                                <i class="fas fa-list-alt text-white text-[30px]"></i>
                            </span>
                            <span class="dash-mtext"><?php echo e(__('Categories')); ?></span>
                        </a>
                    </li>

                    <li class="dash-item">
                        <a href="<?php echo e(route('subcategories.index')); ?>" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                            <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                                <i class="fas fa-sitemap text-white text-[30px]"></i>
                            </span>
                            <span class="dash-mtext"><?php echo e(__('Sub-Categories')); ?></span>
                        </a>
                    </li>

                    <li class="dash-item">
                        <a href="<?php echo e(route('typeofworks.index')); ?>" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                            <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                                <i class="fas fa-tasks text-white text-[30px]"></i>
                            </span>
                            <span class="dash-mtext"><?php echo e(__('Type of Work')); ?></span>
                        </a>
                    </li>
                    ...
                    <li
                        ...
                        <ul class="dash-submenu ">
                                <li class="dash-item <?php echo e(Request::routeIs('vendors.supplier') ? 'active' : ''); ?>">
                                    <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" href="<?php echo e(route('vendors.supplier')); ?>">
                                        <?php echo e(__('Supplier Detail')); ?>

                                    </a>
                                </li>
                                <li class="dash-item <?php echo e(Request::routeIs('vendors.contractor') ? 'active' : ''); ?>">
                                <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" href="<?php echo e(route('vendors.contractor')); ?>">
                                    <?php echo e(__('Contractor Detail')); ?>
            ...
            <!-- Letter Templates -->
            <?php if(\Auth::user()->type == 'company'): ?>
                <li class="dash-item <?php echo e(Request::segment(1) == 'letter_templates' ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('letter_templates.index')); ?>" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                        <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                            <i class="fas fa-envelope-open-text text-white text-[30px]"></i>
                        </span>
                        <span class="dash-mtext"><?php echo e(__('Letter Templates')); ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <!-- Letter Templates -->
            ...
            <li class="dash-item <?php echo e(Request::segment(1) == 'holiday' ? ' active' : ''); ?>">
                <a href="<?php echo e(route('holiday.index')); ?>" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                    <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                        <i class="ti ti-calendar text-white text-[30px]"></i>
                    </span>
                    <span class="dash-mtext"><?php echo e(__('Holidays')); ?></span>
                </a>
            </li>
            ...
            <!-- Exit Formalities -->
                <li
                    ...
                    <a href="#!" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                        ...
                        <span class="dash-mtext">
                            <?php echo e(__('Exit Formalities')); ?>
                    ...
                    <ul class="dash-submenu ">
                        <li class="dash-item <?php echo e(Request::segment(1) == 'setsalary' ? 'active' : '-'); ?>">
                            <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" href="<?php echo e(route('resignation.index')); ?>"><?php echo e(__('Resignation')); ?></a>
                        </li>
                        <li class="dash-item">
                            <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" href="<?php echo e(route('termination.index')); ?>"><?php echo e(__('Exit Formalities')); ?></a>
                        </li>
