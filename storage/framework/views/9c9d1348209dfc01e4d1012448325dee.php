...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Salary Processing')); ?></li>
<?php $__env->stopSection(); ?>
            ...
            <div class="card-header salary-card-header">
                <div class="salary-header-top">
                    <div class="salary-title-wrap">
                        <div>
                            <h5 class="salary-title mb-0"><?php echo e(__('Salary Processing')); ?></h5>
                            <p class="salary-subtitle mb-0"><?php echo e(__('View and manage monthly employee salaries')); ?></p>
                        </div>
                    </div>

                    <div class="salary-filters-wrap">
                        <div class="salary-filter-group">
                            <label class="salary-filter-label"><?php echo e(__('Month')); ?></label>
                            <?php echo e(Form::select('month', $month, date('m'), ['class' => 'form-select salary-filter-select month_date'])); ?>

                        </div>
                        <div class="salary-filter-group">
                            <label class="salary-filter-label"><?php echo e(__('Year')); ?></label>
                            <?php echo e(Form::select('year', $year, date('Y'), ['class' => 'form-select salary-filter-select year_date'])); ?>

                        </div>
                        <div class="salary-filter-group">
                            <label class="salary-filter-label"><?php echo e(__('Department')); ?></label>
                            <?php echo e(Form::select('department_id', $departments, '', ['class' => 'form-select salary-filter-select department_filter', 'placeholder' => __('All Departments')])); ?>

                        </div>
                        <?php if(\Auth::user()->type == 'company' || \Gate::check('payroll.salary_processing.export.all')): ?>
                        <div class="salary-filter-group salary-export-group">
                            <label class="salary-filter-label">&nbsp;</label>
                            <?php echo e(Form::open(['route' => ['salary-processing.export'], 'method' => 'POST', 'id' => 'salary_processing_export_form'])); ?>
                            ...
                            <button type="submit" class="btn btn-primary salary-export-btn" id="export_btn">
                                <i class="ti ti-file-export me-1"></i><?php echo e(__('Export')); ?>
                ...
                <div class="salary-stats-strip" id="salary-stats-strip" style="display:none;">
                    <div class="salary-stat-item">
                        <span class="salary-stat-label"><?php echo e(__('Total Employees')); ?></span>
                        <span class="salary-stat-value" id="stat-total">—</span>
                    </div>
                    <div class="salary-stat-divider"></div>
                    <div class="salary-stat-item">
                        <span class="salary-stat-label"><?php echo e(__('Paid')); ?></span>
                        <span class="salary-stat-value text-success" id="stat-paid">—</span>
                    </div>
                    <div class="salary-stat-divider"></div>
                    <div class="salary-stat-item">
                        <span class="salary-stat-label"><?php echo e(__('Pending')); ?></span>
            ...
            <div class="card-body p-0">
                ...
                <div id="salary-loading" class="salary-loading-overlay">
                    <div class="salary-spinner">
                        ...
                        <span class="salary-loading-text"><?php echo e(__('Loading salary data…')); ?></span>
                    </div>
                </div>
                    ...
                    <table class="table salary-table" id="pc-dt-render-column-cells">
                        <thead>
                            <tr class="salary-thead-single">
                                <th class="col-fixed col-srno"><?php echo e(__('SRNO')); ?></th>
                                <th class="col-fixed col-empcode"><?php echo e(__('EMPCODE')); ?></th>
                                <th class="col-fixed col-empname"><?php echo e(__('EMPNAME')); ?></th>
                                <th class="col-dept"><?php echo e(__('DEPT')); ?></th>
                                <th class="col-sm"><?php echo e(__('COST_CENT')); ?></th>
                                <th class="col-sm"><?php echo e(__('AGE')); ?></th>
                                <th class="col-sm"><?php echo e(__('SEX')); ?></th>
                                <th class="col-doj"><?php echo e(__('DOJ')); ?></th>

                                <th><?php echo e(__('MIN_WAGE_R')); ?></th>
                                <th><?php echo e(__('PROD_PC_RT')); ?></th>
                                <th><?php echo e(__('BASIC_RT')); ?></th>
                                <th><?php echo e(__('MEDICAL_RT')); ?></th>
                                <th><?php echo e(__('HRA_RT')); ?></th>
                                <th><?php echo e(__('CONNVEYANC')); ?></th>
                                <th><?php echo e(__('EDUCATION_')); ?></th>
                                <th><?php echo e(__('EXECUTIVE_')); ?></th>
                                <th><?php echo e(__('LEAVE_ENCA')); ?></th>
                                <th><?php echo e(__('SITE EXPE')); ?></th>
                                <th><?php echo e(__('SPL ALLOW')); ?></th>

                                <th><?php echo e(__('PR_DAYS')); ?></th>
                                <th><?php echo e(__('WEEKLY_OFF')); ?></th>
                                <th><?php echo e(__('PH')); ?></th>
                                <th><?php echo e(__('LWP')); ?></th>
                                <th><?php echo e(__('LEAVE')); ?></th>
                                <th><?php echo e(__('PL')); ?></th>
                                <th><?php echo e(__('PAID_DAYS')); ?></th>
                                <th><?php echo e(__('OT_HRS')); ?></th>

                                <th><?php echo e(__('BASIC')); ?></th>
                                <th><?php echo e(__('MEDICAL')); ?></th>
                                <th><?php echo e(__('HRA')); ?></th>
                                <th><?php echo e(__('CONNVEYAN2')); ?></th>
                                <th><?php echo e(__('EDUCATION')); ?></th>
                                <th><?php echo e(__('EXECUTIVE')); ?></th>
                                <th><?php echo e(__('LEAVE_ENC2')); ?></th>
                                <th><?php echo e(__('SITE EXP2')); ?></th>
                                <th><?php echo e(__('SPL ALLO2')); ?></th>
                                <th><?php echo e(__('Arrears')); ?></th>

                                <th><?php echo e(__('GROSS')); ?></th>

                                <th><?php echo e(__('PF')); ?></th>
                                <th><?php echo e(__('PT')); ?></th>
                                <th><?php echo e(__('MLWF')); ?></th>
                                ...
                                <th><?php echo e(__('PMT_DT')); ?></th>
                                <th><?php echo e(__('SIGNATURE')); ?></th>
                                <th class="col-status"><?php echo e(__('STATUS')); ?></th>
                            </tr>
                        </thead>
...
$(document).ready(function () {
    ...
    function callback() {
        ...
        var ajaxData = { datePicker: datePicker, _token: '<?php echo e(csrf_token()); ?>' };
        ...
        $.ajax({
            url  : '<?php echo e(route('salary-processing.search_json')); ?>',
            type : 'POST',
            data : ajaxData,
    ...
    function renderTable(data) {
        ...
        if (data && data.length > 0) {
            ...
            tr = '<tr><td class="salary-empty-row" colspan="49">' +
                 ...
                 '<span><?php echo e(__('No salary records found for the selected period.')); ?></span></div></td></tr>';
    ...
    function renderError() {
        $('#salary-tbody').html(
            ...
            '<span><?php echo e(__('Failed to load data. Please try again.')); ?></span></div></td></tr>'
        );
    }
    ...
    $(document).on('click', '.mark-payment-btn', function (e) {
        ...
        var month        = $('.month_date').val() || '<?php echo e(date('m')); ?>';
        var year         = $('.year_date').val()  || '<?php echo e(date('Y')); ?>';
        ...
        swal.fire({
            ...
            $.ajax({
                url  : '<?php echo e(route('salary-processing.update-status')); ?>',
                type : 'POST',
                data : { employee_id: employeeId, year: year, month: month, status: newStatus, _token: '<?php echo e(csrf_token()); ?>' },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrm_archivista\resources\views/payslip/salary-processing.blade.php ENDPATH**/ ?>