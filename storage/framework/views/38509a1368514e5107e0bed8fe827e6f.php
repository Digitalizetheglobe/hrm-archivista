    ...
    tailwind.config = {
      theme: {
        extend: {
          ...
          backgroundImage: {
            'hero': "linear-gradient(90deg, rgba(255,255,255,0.97) 30%, rgba(255,255,255,0.6)), url('<?php echo e(asset('landing_new/backgroundfe.png')); ?>')",
  ...
  <style>
    ...
    .hero-bg {
      background: linear-gradient(90deg, rgba(255,255,255,0.97) 30%, rgba(255,255,255,0.6)),
        url('<?php echo e(asset('landing_new/backgroundfe.png')); ?>') center/cover no-repeat fixed;
    }
    .hero-bg::before {
  ...
  <header id="header" class="fixed top-0 left-0 w-full z-[1000] py-5 transition-all duration-400">
    <div class="max-w-[1400px] mx-auto px-[5%] flex justify-between items-center">
      ...
      <a href="#" class="flex items-center">
        <img src="<?php echo e(asset('landing_new/logo.png')); ?>" alt="Connect360" class="w-[160px] sm:w-[190px] transition-all duration-300" />
      </a>
      ...
      <div class="flex items-center gap-6">
        <a href="<?php echo e(route('login')); ?>" class="hidden lg:inline-flex items-center justify-center px-8 py-2.5 rounded-full font-bold text-sm bg-[#2e9ec6] text-white shadow-lg shadow-blue-200 hover:bg-[#2589ad] hover:-translate-y-0.5 transition-all duration-300">
          Login
        </a>
        <!-- Mobile toggle -->
    ...
    <div id="mobile-nav" class="fixed top-0 w-4/5 max-w-sm h-screen bg-white z-[1000] shadow-2xl flex items-center px-10 py-20">
      <div class="w-full flex flex-col gap-6">
        ...
        <a href="<?php echo e(route('login')); ?>" class="mt-4 inline-flex justify-center items-center gap-2 px-6 py-3 rounded-full font-semibold text-sm bg-[#2e9ec6] text-white transition-all duration-300">Login</a>
      </div>
    </div>
  </header>
      ...
      <div class="feature-showcase bg-white backdrop-blur-xl rounded-4xl p-10 md:p-20 border border-white/80 relative overflow-hidden" style="box-shadow: 0 40px 100px -20px rgba(31,38,135,0.08);">
        ...
        <div class="grid md:grid-cols-2 gap-20 items-center relative z-10">
          ...
          <div class="showcase-visual relative flex justify-center items-center">
            <div class="">
              <div class="">
                <video src="<?php echo e(asset('landing_new/mobile.mp4')); ?>" autoplay loop muted playsinline class="w-full h-full object-cover block"></video>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="max-w-[1400px] mx-auto px-[5%]">
      <div class="grid md:grid-cols-2 gap-20 items-center">
        ...
        <div class="about-visual">
          <img src="<?php echo e(asset('landing_new/HRMFE.gif')); ?>" alt="Dashboard Preview" class="rounded-3xl" style="box-shadow: 0 40px 80px rgba(0,0,0,0.1);" />
        </div>
        <!-- Content -->
    ...
    <div class="video-modal-content relative w-[90%] max-w-4xl rounded-3xl overflow-hidden">
      ...
      <div class="aspect-video w-full bg-black">
        <video id="modalVideo" controls class="w-full h-full object-contain">
          <source src="<?php echo e(asset('landing_new/mobile.mp4')); ?>" type="video/mp4" />
...
<?php /**PATH C:\xampp\htdocs\hrm_archivista\Modules/LandingPage\Resources/views/layouts/home.blade.php ENDPATH**/ ?>