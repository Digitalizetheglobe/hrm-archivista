...
<head>
    ...
    <title> Connect360 | Innovative Business Solutions and HRM Functions  </title>
        ...
        <link rel="stylesheet" href="<?php echo e(Module::asset('LandingPage:Resources/views/layouts/zohocustom.css')); ?>">
        <!-- <link rel="stylesheet" href="<?php echo e(Module::asset('LandingPage:Resources/views/layouts/2474.css')); ?>"> -->
        <link rel="stylesheet" href="<?php echo e(Module::asset('LandingPage:Resources/views/layouts/style.css')); ?>">
    ...
    <!-- Banner End -->
     ...
     <section class="feature-section">
        ...
        <div class="feature-image">
            <img src="<?php echo e(asset('Modules/LandingPage/Resources/views/layouts/images/HRM.gif')); ?>" alt="Description of image">
        </div>
    </section>
    ...
    <!-- Feture SHow -->
        <section id="feture-show">
            ...
            <div class="image-container">
                <img src="<?php echo e(asset('Modules/LandingPage/Resources/views/layouts/images/HRMFE.gif')); ?>" alt="HR Management" class="big-image">
            </div>  
        </section>
     ...
     <section id="function-section">
        ...
        <div class="card-section">
            <div class="container">
                <div class="card">
                    <img src="<?php echo e(asset('Modules/LandingPage/Resources/views/layouts/images/meeting.gif')); ?>" alt="Meeting Icon">
                ...
                <div class="card">
                    <img src="<?php echo e(asset('Modules/LandingPage/Resources/views/layouts/images/clock.gif')); ?>" alt="Clock Icon">
                ...
                <div class="card">
                    <img src="<?php echo e(asset('Modules/LandingPage/Resources/views/layouts/images/leave.gif')); ?>" alt="Leave Icon">
        ...
        <div class="card-section second-card">
            <div class="container">
                <div class="card">
                    <img src="<?php echo e(asset('Modules/LandingPage/Resources/views/layouts/images/salary.gif')); ?>" alt="Salary Icon">
                ...
                <div class="card">
                    <img src="<?php echo e(asset('Modules/LandingPage/Resources/views/layouts/images/document.gif')); ?>" alt="Document Icon">
                ...
                <div class="card last-crad">
                    <img src="<?php echo e(asset('Modules/LandingPage/Resources/views/layouts/images/tick.gif')); ?>" alt="Tick Icon">
            ...
            <div class="section middle-section">
                <div class="phone-container">
                    <video autoplay loop muted playsinline>
                        <source src="<?php echo e(asset('Modules/LandingPage/Resources/views/layouts/images/mobile.mp4')); ?>" type="video/mp4">
        ...
        <div class="container-call call-to-action">
            <div class="app-content">
                ...
                <div class="app-buttons">
                    <a href="<?php echo e(route('contact')); ?>" class="google-play-button">
                        Schedule A Demo
                    </a>
                </div>
            </div>
            <div class="app-image">
                <img src="<?php echo e(asset('Modules/LandingPage/Resources/views/layouts/images/call-to.gif')); ?>" alt="Demo Image">
            </div>
        </div>
    </section>
         ...
         <section>
			...
			<div id="whatsapp-button" 
				 style="position: fixed; z-index: 100;
						...
						cursor: pointer;">
				<img src="<?php echo e(asset('Modules/LandingPage/Resources/views/layouts/images/whatsapp.png')); ?>" 
					 alt="WhatsApp" 
            ...
            <div id="demo-popup" class="demo-popup-overlay">
                <div class="demo-popup-container">
                    <div class="demo-popup-image">
                        <img src="<?php echo e(asset('Modules/LandingPage/Resources/views/layouts/images/popup1.png')); ?>" alt="Demo Image">
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\hrm_archivista\Modules/LandingPage\Resources/views/layouts/home.blade.php ENDPATH**/ ?>