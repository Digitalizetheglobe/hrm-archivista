                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <tr>
                            <td style="width: 30%; border-right: 2px solid #000; padding: 15px; text-align: center; vertical-align: middle;">
                                <img style="border: 1px solid black;" src="<?php echo e(asset('storage/uploads/logo/logo.webp')); ?>" width="150px" onerror="this.onerror=null; this.src='<?php echo e(url('storage/uploads/logo/logo.svg')); ?>';">
                                <br>
                            ...
                            <td style="width: 33.33%; border-right: 2px solid #000; padding: 0; vertical-align: top;">
                                <table style="width: 100%; border-collapse: collapse;">
                                    <tr style="border-bottom: 1px solid #000;">
                                        ...
                                        <td style="padding: 8px; border-left: 1px solid #000;"><?php echo e(ucwords(strtolower($employee->name))); ?></td>
                                    </tr>
                                    <tr style="border-bottom: 1px solid #000;">
                                        <td style="padding: 8px; font-weight: bold;">Department:</td>
                                        <td style="padding: 8px; border-left: 1px solid #000;"><?php echo e($employee->department->name ?? 'Assistant Manager - Talent Acquisition'); ?></td>
                                    </tr>
                                    <tr style="border-bottom: 1px solid #000;">
                                    ...
                                    <tr style="border-bottom: 1px solid #000;">
                                        ...
                                        <td style="padding: 8px; border-left: 1px solid #000;"><?php echo e($employee->esic_no ?? 'N/A'); ?></td>
                                    </tr>
                            ...
                            <td style="width: 33.33%;  padding: 0; vertical-align: top;">
                                <table style="width: 100%; border-collapse: collapse;">
                                    <tr style="border-bottom: 1px solid #000;">
                                        ...
                                        <td style="padding: 8px; border-left: 1px solid #000;"><?php echo e(\Auth::user()->employeeIdFormat($employee->employee_id)); ?></td>   
                                    </tr>
                                    <tr style="border-bottom: 1px solid #000;">
                                    ...
                                    <tr style="border-bottom: 1px solid #000;">
                                        ...
                                        <td style="padding: 8px; border-left: 1px solid #000;"><?php echo e($pfNumber); ?></td>
                                    </tr>
                                    <tr style="border-bottom: 1px solid #000;">
                                        <td style="padding: 8px; font-weight: bold;">Bank Account Number:</td>
                                        <td style="padding: 8px; border-left: 1px solid #000;"><?php echo e($employee->bank_ac_no ?? 'N/A'); ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td style="width: 50%; border-right: 2px solid #000; padding: 0; vertical-align: top;">
                                <table style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <?php if(!empty($leaveDetails)): ?>
                                        ...
                                        <tr>
                                            <td style="padding: 8px; font-size: 11px; border-bottom: 1px solid #000; border-right: 1px solid #000; text-align: center;"><?php echo e($leave['title']); ?></td>
                                            <td style="padding: 8px; font-size: 11px; border-bottom: 1px solid #000; border-right: 1px solid #000; text-align: right;"><?php echo e(number_format($leave['opening_balance'], 2)); ?></td>
                                            <td style="padding: 8px; font-size: 11px; border-bottom: 1px solid #000; border-right: 1px solid #000; text-align: right;"><?php echo e(number_format($leave['credited'], 2)); ?></td>
                                            <td style="padding: 8px; font-size: 11px; border-bottom: 1px solid #000; border-right: 1px solid #000; text-align: right;"><?php echo e(number_format($leave['availed'], 2)); ?></td>
                                            <td style="padding: 8px; font-size: 11px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(number_format($leave['closing_balance'], 2)); ?></td>
                                        </tr>
                                        <?php
                            ...
                            <td style="width: 50%; padding: 0; vertical-align: top;">
                                <table style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 8px; font-size: 11px; border-bottom: 1px solid #000; text-align: right;"><?php echo e($presentDays); ?></td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 8px; font-size: 11px; border-bottom: 1px solid #000; border-right: 1px solid #000;">Weekly Off</td>
                                        <td style="padding: 8px; font-size: 11px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(number_format($weeklyOff, 2)); ?></td>
                                    </tr>
                                    <tr >
                                        <td style="padding: 8px; font-size: 11px; border-bottom: 1px solid #000; border-right: 1px solid #000;">Total Leave</td>
                                        <td style="padding: 8px; font-size: 11px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(number_format($totalAvailed, 2)); ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 8px; font-size: 11px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(number_format($holidays, 2)); ?></td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 8px; font-size: 11px; border-bottom: 1px solid #000; border-right: 1px solid #000;">LWP</td>
                                        <td style="padding: 8px; font-size: 11px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(number_format($lwpDays, 2)); ?></td>
                                    </tr>
                                    <tr style="background-color: #f8f9fa;">
                                        <td style="padding: 8px; font-size: 11px; font-weight: bold; border-right: 1px solid #000;">Days Payable</td>
                                        <td style="padding: 8px; font-size: 11px; font-weight: bold; text-align: right;"><?php echo e(number_format($calculatedDaysPayable, 2)); ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <td style="width: 50%; border-right: 2px solid #000; padding: 0; vertical-align: top; ">
                                    <table style="width: 100%; border-collapse: collapse;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat($conveyanceComponent)); ?></td>
                                        </tr>
                                        <tr style="height: 35px;">
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; border-right: 1px solid #000;">EDUCATION</td>
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat($educationAllowance)); ?></td>
                                        </tr>
                                        <tr style="height: 35px;">
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; border-right: 1px solid #000;">EXECUTIVE</td>
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat($executive)); ?></td>
                                        </tr>
                                        <?php if(!empty($employeeAllowances)): ?>
                                            ...
                                            <tr>
                                                <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; border-right: 1px solid #000;"><?php echo e(strtoupper($allowance['type'])); ?></td>
                                                <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat($allowance['amount'])); ?></td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                        <tr style="height: 35px;">
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; border-right: 1px solid #000;">Extra Allowance</td>
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat($extraAllowance ?? 0)); ?></td>
                                        </tr>
                                        <tr style="background-color: #f8f9fa;">
                                            <td style="padding: 10px; font-size: 14px; font-weight: bold; border-right: 1px solid #000;">Gross Earning (A)</td>
                                            <td style="padding: 10px; font-size: 14px; font-weight: bold; text-align: right;"><?php echo e(\Auth::user()->priceFormat($grossSalaryWithExtra)); ?></td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td style="width: 50%; padding: 0; vertical-align: top;">
                                    <table style="width: 100%; border-collapse: collapse;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat($esiDeduction)); ?></td>
                                        </tr>

                                        <tr>
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; border-right: 1px solid #000;">PF</td>
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat($pfDeduction)); ?></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat($mlwfDeduction)); ?></td>
                                        </tr>

                                        <tr>
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; border-right: 1px solid #000;">Advance</td>
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat($advanceDeduction)); ?></td>
                                        </tr>

                                        <tr>
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; border-right: 1px solid #000;">Other Deduction</td>
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat($otherDeduction)); ?></td>
                                        </tr>

                                        <!-- <tr>
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; border-right: 1px solid #000;">TDS</td>
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat($tdsDeduction)); ?></td>
                                        </tr>                                        

                                        <tr>
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; border-right: 1px solid #000;">Absent Days (<?php echo e($absentDaysNew); ?> days)</td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 8px; font-size: 12px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat(0)); ?></td>
                                        </tr>
