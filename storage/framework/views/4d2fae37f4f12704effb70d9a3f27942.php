...
<div class="ld-filter-bar">
    <div class="filter-group">
        <label for="month_filter"><?php echo e(__('Select Month')); ?></label>
        <input type="month" id="month_filter" name="month" class="form-control"
               value="<?php echo e($selectedMonth); ?>" onchange="updateFilters()">
    </div>
    <div class="filter-group">
        <label for="employee_search"><?php echo e(__('Search Employee')); ?></label>
    ...
    <?php if(request()->get('search')): ?>
        <div class="filter-group" style="justify-content: flex-end; flex: 0 0 auto;">
            <label>&nbsp;</label>
            <a href="?month=<?php echo e($selectedMonth); ?>"
               class="btn btn-sm"
...
<div class="ld-stats-row">
    <div class="stat-card sc-primary">
        ...
        <div class="stat-text">
            ...
            <div class="stat-value"><?php echo e($monthlySummary['total_leaves']); ?><span class="stat-unit">Days</span></div>
        </div>
    </div>
    <div class="stat-card sc-success">
        ...
        <div class="stat-text">
            ...
            <div class="stat-value"><?php echo e($monthlySummary['credited_leaves']); ?><span class="stat-unit">Days</span></div>
        </div>
    </div>
    <div class="stat-card sc-warning">
        ...
        <div class="stat-text">
            ...
            <div class="stat-value"><?php echo e($monthlySummary['used_leaves']); ?><span class="stat-unit">Days</span></div>
        </div>
    </div>
    <div class="stat-card sc-info">
        ...
        <div class="stat-text">
            ...
            <div class="stat-value"><?php echo e($monthlySummary['remaining_leaves']); ?><span class="stat-unit">Days</span></div>
        </div>
    </div>
</div>
...
<div class="category-section">
    <div class="category-header">
        ...
        <div>
            <h4><?php echo e(__('Contract (Confirm) Employees')); ?></h4>
            <div class="cat-subtitle"><?php echo e(__('Confirmed contract & consultant staff')); ?></div>
        </div>
        <span class="cat-badge" style="background: rgba(232,89,12,0.1); color: #e8590c;">
            <?php echo e($contractConfirmEmployees->count()); ?> <?php echo e(__('Employees')); ?>
                    ...
                    <tr class="emp-row">
                        <td colspan="5">
                            <div class="d-flex align-items-center">
                                <div class="emp-avatar"><?php echo e($initials); ?></div>
                                <div>
                                    <div class="emp-name"><?php echo e($emp->name); ?></div>
                                    <div class="emp-email"><?php echo e($emp->email); ?></div>
                                </div>
                            </div>
                        </td>
                    </tr>
                    <?php $__currentLoopData = $leaveBalances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leaveBalance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td style="padding-left: 28px !important;">
                                <span class="leave-type-name"><?php echo e($leaveBalance['leave_type']->title); ?></span>
                                <?php if($leaveBalance['is_unlimited']): ?>
                                    <span class="badge" style="background: rgba(14,165,233,0.12); color: #0ea5e9; font-size: 10px; font-weight: 700; border-radius: 6px; padding: 3px 8px; margin-left: 6px;"><?php echo e(__('Unlimited')); ?></span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if($leaveBalance['is_unlimited']): ?>
                                ...
                                <?php else: ?>
                                    <span class="days-value" style="color: #475569;"><?php echo e($leaveBalance['allocated_days']); ?></span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if($leaveBalance['carried_forward_days'] > 0): ?>
                                    <span class="days-value text-success">+<?php echo e($leaveBalance['carried_forward_days']); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">—</span>
                                <?php endif; ?>
                            </td>
                            <td><span class="days-value" style="color: #f59e0b;"><?php echo e($leaveBalance['used_days']); ?></span></td>
                            <td>
                                <?php if($leaveBalance['is_unlimited']): ?>
                                    <span class="days-value text-info"><?php echo e(__('Unlimited')); ?></span>
                                <?php else: ?>
                                    <span class="days-value <?php echo e($leaveBalance['remaining_days'] > 0 ? 'text-success' : 'text-danger'); ?>">
...
<div class="category-section">
    <div class="category-header">
        ...
        <div>
            <h4><?php echo e(__('Contract (Not Confirm) Employees')); ?></h4>
            <div class="cat-subtitle"><?php echo e(__('Unconfirmed contract & consultant staff')); ?></div>
        </div>
        <span class="cat-badge" style="background: rgba(245,158,11,0.12); color: #d97706;">
            <?php echo e($contractNotConfirmEmployees->count()); ?> <?php echo e(__('Employees')); ?>
            ...
            <tbody>
                <?php $__currentLoopData = $leaveDetails['contract_not_confirm']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employeeDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr class="emp-row">
                        <td colspan="5">
                            <div class="d-flex align-items-center">
                                <div class="emp-avatar" style="background: linear-gradient(135deg, #f59e0b, #fbbf24);"><?php echo e($initials); ?></div>
                                <div>
                                    <div class="emp-name"><?php echo e($emp->name); ?></div>
                                    <div class="emp-email"><?php echo e($emp->email); ?></div>
                                </div>
...
<div class="category-section">
    <div class="category-header">
        ...
        <div>
            <h4><?php echo e(__('Payroll Employees')); ?></h4>
            <div class="cat-subtitle"><?php echo e(__('Full-time payroll staff')); ?></div>
        </div>
        <span class="cat-badge" style="background: rgba(34,197,94,0.12); color: #16a34a;">
            <?php echo e($payrollEmployees->count()); ?> <?php echo e(__('Employees')); ?>
            ...
            <tbody>
                <?php $__currentLoopData = $leaveDetails['payroll']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employeeDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr class="emp-row">
                        <td colspan="5">
                            <div class="d-flex align-items-center">
                                <div class="emp-avatar" style="background: linear-gradient(135deg, #22c55e, #4ade80);"><?php echo e($initials); ?></div>
                                <div>
                                    <div class="emp-name"><?php echo e($emp->name); ?></div>
                                    <div class="emp-email"><?php echo e($emp->email); ?></div>
                                </div>
...
<div class="empty-state">
    ...
    <?php if(request()->get('search')): ?>
        <h5 style="font-weight: 700; color: #1e293b;"><?php echo e(__('No results found')); ?></h5>
        <p class="text-muted" style="max-width: 340px; margin: 8px auto 0;"><?php echo e(__('No employees matched your search. Try a different name or email.')); ?></p>
        <a href="?month=<?php echo e($selectedMonth); ?>" class="btn btn-sm mt-3" style="border: 1.5px solid #e2e8f0; border-radius: 9px; color: #64748b; background: #f8fafc; padding: 8px 18px; font-size: 13px; font-weight: 600;">
            <i class="fas fa-times me-1"></i><?php echo e(__('Clear Search')); ?>

        </a>
    <?php else: ?>
        <h5 style="font-weight: 700; color: #1e293b;"><?php echo e(__('No employees found')); ?></h5>
        <p class="text-muted" style="max-width: 340px; margin: 8px auto 0;"><?php echo e(__('There are no employees in the system yet.')); ?></p>
    <?php endif; ?>
</div>
<?php endif; ?>
