...
try {
    \Log::info('Starting invoice generation', ['timestamp' => now()]);
    ...
    \Log::info('Invoice generation completed successfully');
                        ...
                        <table style="width: 100%; border-collapse: collapse; border-top: 2px solid #000;">
                            <tr>
                                ...
                                <td style="width: 33.33%; border-right: 2px solid #000; padding: 0; vertical-align: top; ">
                                    <table style="width: 100%; border-collapse: collapse;">
                                        <tr style="background-color: #f8f9fa;">
                                            <th colspan="2" style="padding: 4px; text-align: center; font-size: 14px; font-weight: bold; border-bottom: 1px solid #000;">Earnings</th>
                                        </tr>
                                        <tr style="background-color: #f8f9fa;">
                                            <th style="padding: 4px; font-size: 11px; font-weight: bold; border-bottom: 1px solid #000; border-right: 1px solid #000;">Components</th>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 4px; font-size: 11px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat($grossSalaryWithExtra)); ?></td>
                                        </tr>
                                        <?php for($i = $earningsCount; $i < $maxRows; $i++): ?>
                                        <tr>
                                ...
                                <td style="width: 33.33%; border-right: 2px solid #000; padding: 0; vertical-align: top;">
                                    <table style="width: 100%; border-collapse: collapse;">
                                        <tr style="background-color: #f8f9fa;">
                                            <th colspan="2" style="padding: 4px; text-align: center; font-size: 14px; font-weight: bold; border-bottom: 1px solid #000;">Deductions</th>
                                        </tr>
                                        <tr style="background-color: #f8f9fa;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 4px; font-size: 11px; border-bottom: 1px solid #000; text-align: right;"><?php echo e(\Auth::user()->priceFormat($tdsDeduction)); ?></td>
                                        </tr>
                                        ...
                                        <?php for($i = $deductionsCount; $i < $maxRows; $i++): ?>
                                        <tr>
                                            <td style="padding: 4px; font-size: 11px; border-bottom: 1px solid #000; border-right: 1px solid #000;">&nbsp;</td>
                                            <td style="padding: 4px; font-size: 11px; border-bottom: 1px solid #000;">&nbsp;</td>
                                        </tr>
                                ...
                                <td style="width: 33.34%; padding: 0; vertical-align: top;">
                                    <table style="width: 100%; border-collapse: collapse;">
                                        ...
                                        <?php endif; ?>
                                        <?php for($i = $annualIncomeCount; $i < $maxRows; $i++): ?>
                                        <tr>
                                            <td style="padding: 4px; font-size: 11px; border-bottom: 1px solid #000; border-right: 1px solid #000;">&nbsp;</td>
                                            <td style="padding: 4px; font-size: 11px; border-bottom: 1px solid #000;">&nbsp;</td>
                                        </tr>
...
<script>
    function saveAsPDF() {
        ...
        var opt = {
            margin: 0.1,
            filename: '<?php echo e($employee->name); ?>_<?php echo e($payslip->salary_month); ?>_invoice',
            image: {
                type: 'jpeg',
                quality: 1
            },
