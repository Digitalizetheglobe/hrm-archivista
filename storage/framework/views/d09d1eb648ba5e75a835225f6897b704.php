<?php echo e(Form::open(['url' => 'projects', 'method' => 'post'])); ?>
                ...
                <div class="form-icon-user">
                    <select class="form-control" name="client_id" required>
                        ...
                        <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $client_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>"><?php echo e($client_name); ?></option>
...
<?php echo e(Form::close()); ?><?php /**PATH C:\xampp\htdocs\hrm_archivista\resources\views/projects/create.blade.php ENDPATH**/ ?>