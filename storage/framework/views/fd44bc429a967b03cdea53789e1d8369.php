                ...
                <select name="leave_type_id" id="leave_type_id" class="form-control lf-form-control" style="padding-left:34px;">
                    ...
                    <?php $__currentLoopData = $leavetypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($leave->title == 'LWP' || $leave->title == 'WFH'): ?>
                            <option value="<?php echo e($leave->id); ?>" data-unlimited="true" data-more-than-3-5="<?php echo e($leave->more_than_3_5_leaves ? 'true' : 'false'); ?>"><?php echo e($leave->title); ?> (Unlimited)</option>
                        <?php else: ?>
                            <option value="<?php echo e($leave->id); ?>" data-unlimited="false" data-period="<?php echo e($leave->type); ?>" data-carry-forward="<?php echo e($leave->carry_forward_enabled ? 'true' : 'false'); ?>" data-more-than-3-5="<?php echo e($leave->more_than_3_5_leaves ? 'true' : 'false'); ?>">
    ...
    $(document).ready(function() {
        ...
        function calculateDays() {
            ...
            if (startDate && endDate) {
                $.ajax({
                    url: '<?php echo e(route('leave.calculate_days')); ?>',
                    type: 'POST',
                    data: {
