    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::date('start_date', date('Y-m-d'), ['class' => 'form-control', 'required' => 'required'])); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::date('end_date', date('Y-m-d'), ['class' => 'form-control', 'required' => 'required'])); ?>
