...
<?php $__env->startSection('content'); ?>
    <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'hr'): ?>
        <div class="col-sm-12 col-lg-12 col-xl-12 col-md-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <?php echo e(Form::open(['route' => ['invoice.store'], 'method' => 'POST', 'id' => 'invoice_form'])); ?>
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-auto float-end ms-2 mt-4">
                            <a href="#" class="btn  btn-primary"
                                ...
                                data-bs-toggle="tooltip" title="<?php echo e(__('invoice')); ?>"
                                data-original-title="<?php echo e(__('invoice')); ?>"><?php echo e(__('Generate Invoice')); ?>
                ...
                <div class="row">
                    <div class="col-md-4" style="margin-bottom: 10px;">
                        <div class="d-flex align-items-center justify-content-start">
                            <h5><?php echo e(__('Find Employee Invoice')); ?></h5>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="d-flex align-items-center justify-content-end">
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mx-2">
                                <div class="btn-box">
                                    <?php echo e(Form::select('employee_id', $employeeList, isset($_GET['employee_id']) ? $_GET['employee_id'] : '', ['class' => 'form-control employee_id '])); ?>
                            ...
                            <?php if(Auth::user()->type == 'company' || Auth::user()->type == 'hr'): ?>
                                <?php echo e(Form::open(['route' => ['invoice.export'], 'method' => 'POST', 'id' => 'invoice_export_form'])); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function callback() {
                ...
                $.ajax({
                    url: '<?php echo e(route('invoice.search_json')); ?>',
                    type: 'POST',
                    data: {
                    ...
                    success: function(data) {
                        ...
                        function renderButton(data, cell, row) {
                            ...
                            if (data != 0) {
                                var payslip =
                                    '<a href="#" data-url="<?php echo e(url('invoice/pdf/')); ?>/' + id +
                                    '/' + datePicker +
                                    '" data-size="md-pdf"  data-ajax-popup="true" class="btn btn-primary" data-title="<?php echo e(__('Employee Invoice')); ?>">' +
                                    '<?php echo e(__('Invoice')); ?>' + '</a> ';
                            }

                            if (status == "UnPaid" && data != 0) {
                                clickToPaid = '<a href="<?php echo e(url('invoice/paysalary/')); ?>/' + id +
                            ...
                            if (data != 0) {
                                view =
                                    '<a href="#" data-url="<?php echo e(url('invoice/showemployee/')); ?>/' +
                                    payslip_id +
                            ...
                            if (data != 0 && status == "UnPaid") {
                                edit =
                                    '<a href="#" data-url="<?php echo e(url('invoice/editemployee/')); ?>/' +
                                    payslip_id +
                        ...
                        if (data.length > 0) {
                            $.each(data, function(indexInArray, valueOfElement) {
                                ...
                                if (valueOfElement[7] != 0) {
                                    var payslip =
                                        '<a href="#" data-url="<?php echo e(url('invoice/pdf/')); ?>/' +
                                        id + '/' + datePicker +
                                        '" data-size="lg"  data-ajax-popup="true" class=" btn-sm btn btn-warning" data-title="<?php echo e(__('Employee Invoice')); ?>">' +
                                        '<?php echo e(__('Invoice')); ?>' + '</a> ';
                                }
                                if (valueOfElement[5] == "UnPaid" && valueOfElement[6] != 0) {
                                    var clickToPaid =
                                        '<a href="<?php echo e(url('invoice/paysalary/')); ?>/' + id +
                                        '/' + datePicker +
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrm_archivista\resources\views/invoice/index.blade.php ENDPATH**/ ?>