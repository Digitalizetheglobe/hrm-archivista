<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('TDS Management')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Home')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('TDS')); ?></li>
<?php $__env->stopSection(); ?>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header card-body table-border-style">
                <h5><?php echo e(__('TDS Details')); ?></h5>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if(isset($employee->tds_type)): ?>
                                            <?php if($employee->tds_type == 0): ?>
                                    ...
                                    <td><?php echo e(isset($employee->total_tax_amount) ? formatIndian($employee->total_tax_amount) : '0'); ?></td>
                                    <td>
                                        <?php if(isset($employee->tds_type) && isset($employee->monthly_tds)): ?>
                                            <?php echo e(formatIndian($employee->monthly_tds)); ?>
                                    ...
                                    <td>
                                        <button type="button" 
                                                ...
                                                data-current-tds-type="<?php echo e($employee->tds_type ?? ''); ?>">
                                            <i class="ti ti-edit"></i> <?php echo e(__('Edit')); ?>

                                        </button>
                                        <?php if(isset($employee->tds_type)): ?>
                                            <a href="<?php echo e($employee->tds_type == 0 ? route('tds.old.regime', $employee->id) : route('tds.new.regime', $employee->id)); ?>" 
                                               class="btn btn-sm btn-success tds-regime-btn">
                                                <i class="ti ti-calculator"></i> <?php echo e(__('TDS')); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function saveTdsTypeFunction() {
            ...
            $.ajax({
                url: '<?php echo e(route("tds.save.type")); ?>',
                method: 'POST',
                data: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrm_archivista\resources\views/tds/index.blade.php ENDPATH**/ ?>