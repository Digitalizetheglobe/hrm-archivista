...
<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0"><?php echo e(__('Edit Letter Template')); ?></h5>
    </div>
<?php $__env->stopSection(); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#source_letter').change(function() {
                ...
                if (letterName) {
                    if (confirm('Loading letter content will replace the current content. Do you want to continue?')) {
                        $.ajax({
                        ...
                        $(this).val('<?php echo e($letterTemplate->source_letter ?? ''); ?>');
                    }
                }
            });
        });
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary"><?php echo e(__('Edit Letter Template')); ?></h6>
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('letter_templates.update', $letterTemplate->id)); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" value="<?php echo e($letterTemplate->name); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="source_letter" name="source_letter">
                                            ...
                                            <?php $__currentLoopData = $letters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $letter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($letter); ?>" <?php echo e(($letterTemplate->source_letter == $letter) ? 'selected' : ''); ?>><?php echo e($letter); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <small class="text-muted"><?php echo e(__('Select a letter to load its content as a starting point (will replace current content)')); ?></small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="content" name="content" class="form-control" required><?php echo $letterTemplate->content; ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <div class="float-right">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> <?php echo e(__('Update Template')); ?>
                ...
                <div class="card mt-3">
                    <div class="card-header">
                        <h6 class="m-0 font-weight-bold text-warning"><?php echo e(__('Template Preview')); ?></h6>
                    </div>
                    <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrm_archivista\resources\views/letter_templates/edit.blade.php ENDPATH**/ ?>