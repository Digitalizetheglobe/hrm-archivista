            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    <div class="" id="business-settings">
                        <form method="POST" action="<?php echo e(route('business.setting')); ?>" enctype="multipart/form-data" class="d-contents">
    <?php echo csrf_field(); ?>
                        <div class="row">
                                            ...
                                            <div class="list-group">
                                                <div class="list-group-item form-switch form-switch-right">
                                                    ...
                                                    <input class="form-check-input" name='<?php echo e($EmailTemplate->id); ?>'
                                                        id="email_tempalte_<?php echo e($template_id); ?>"
                                                        type="checkbox"
                                                        <?php if($is_active == 1): ?> checked="checked" <?php endif; ?>
                                                        value="1"
                                                        data-url="<?php echo e(route('company.email.setting', [$template_id])); ?>" />
                                                    <label class="form-check-label"
                                                        for="email_tempalte_<?php echo e($template_id); ?>"></label>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrm_archivista\resources\views/setting/company_settings.blade.php ENDPATH**/ ?>