                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button type="button" class="btn btn-outline-secondary toggle-password" data-target="#password" aria-label="<?php echo e(__('Show password')); ?>">
                                                <i class="ti ti-eye"></i>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" name="employee_type" id="employee_type">
                                            ...
                                            <option value="Consultant" <?php echo e((is_object($employee) && $employee->employee_type == 'Consultant') ? 'selected' : ''); ?>><?php echo e(__('Consultant')); ?></option>
                                    ...
                                    <div class="form-group col-md-6" id="per_day_rate_field" style="display: none;">
                                        <?php echo Form::label('per_day_rate', __('Per Day Rate'), ['class' => 'form-label']); ?>

                                        <?php echo Form::number('per_day_rate', is_object($employee) ? $employee->per_day_rate : null, ['class' => 'form-control', 'step' => '0.01', 'min' => '0', 'placeholder' => 'Enter per day rate']); ?>
