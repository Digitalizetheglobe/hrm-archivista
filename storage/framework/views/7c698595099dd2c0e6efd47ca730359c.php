                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="employee_type" id="employee_type">
                                                ...
                                                <option value="Consultant"><?php echo e(__('Consultant')); ?></option>
                                        ...
                                        <div class="form-group col-md-6" id="per_day_rate_field" style="display: none;">
                                            ...
                                            <?php echo Form::number('per_day_rate', null, ['class' => 'form-control', 'step' => '0.01', 'min' => '0', 'placeholder' => 'Enter per day rate']); ?>
