    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createAllowanceModalLabel"><?php echo e(__('Create Allowance')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="createAllowanceForm" method="POST" action="<?php echo e(route('allowance.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label class="form-label"><?php echo e(__('Allowance Type')); ?> <span class="text-danger">*</span></label>
                            <select class="form-control" id="allowance_type" name="allowance_type" required>
                                <option value=""><?php echo e(__('Select Type')); ?></option>
                                <?php $__currentLoopData = $allowanceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>"><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <small class="text-muted"><?php echo e(__('Select allowance type')); ?></small>
                        </div>
                        <div class="form-group col-md-6">
                            <label class="form-label"><?php echo e(__('Month')); ?> <span class="text-danger">*</span></label>
                            <input type="month" class="form-control" id="month" name="month" required>
                            <small class="text-muted"><?php echo e(__('Select month for allowance')); ?></small>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <small class="text-muted"><?php echo e(__('Enter allowance amount')); ?></small>
                        </div>
                        <div class="form-group col-md-12">
                            ...
                            <small class="text-muted"><?php echo e(__('Optional remark for this allowance')); ?></small>
                        </div>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('createAllowanceForm').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route("allowance.store")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
...
<?php /**PATH C:\xampp\htdocs\hrm_archivista\resources\views/allowance/create.blade.php ENDPATH**/ ?>